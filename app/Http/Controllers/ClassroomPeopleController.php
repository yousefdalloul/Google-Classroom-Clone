...
//        dd(
//            $classroom->users,                          //many-to-many with classrooms and users
//            $classroom->classworks()->first()->users    //many-to-many with classwork and users for the room in
//        );
    ...
    public function destroy(Request $request,Classroom $classroom,)
    {
        ...
        if ($user_id == $classroom->user_id){
            return redirect()
                ...
                ->with('error','Cannot remove the user!');
        }
